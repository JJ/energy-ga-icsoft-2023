...
ggsave("../../img/fig1-onemax-PKG-vs-seconds.png", width=12, height=8)
...
ggsave("../../img/fig2-onemax-PKG-vs-size.png", width=12, height=8)
...
ggsave("../../img/fig3-over-PKG-vs-seconds.png", width=12, height=8)
...
ggsave("../../img/fig4-over-PKG-vs-size.png", width=12, height=8)
