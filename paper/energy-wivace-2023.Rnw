...
The charts presented in Figure \ref{fig:onemax} show that there is indeed a
variation for all three runtimes and the way they vary is different. 
...
the energy consumption and time. At any rate, the fact that unexpected
