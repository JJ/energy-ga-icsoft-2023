...
issues open. In this edition, we will widen the results, looking at different
factors
...
\item A more complete operation of an evolutionary algorithm will be tested:
...
as modifing these algorithms or their implementations so they consume less
...
experimental studies. Green computing principles have been establishied as a
