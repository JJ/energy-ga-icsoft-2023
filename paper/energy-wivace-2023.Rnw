...
<<r crossover, echo=F, fig.height=6, fig.cap="PKG consumption, in Joules, vs. time in seconds, for the crossover and the three different virtual machines, shown as a boxplot.\\protect\\label{fig:xover:vms}">>=
