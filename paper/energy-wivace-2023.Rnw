...
%
<<r onemax.vms, echo=F, fig.height=6, fig.cap="Boxplot of PKG measurements OneMax problem and the three different virtual machines.\\protect\\label{fig:onemax:energy}">>=
...
<<r crossover, echo=F, fig.height=6, fig.cap="PKG consumption for the crossover and the three different virtual machines, shown as a boxplot.\\protect\\label{fig:xover:vms}">>=
...
<<r mutation, echo=F, fig.height=6, fig.cap="PKG consumption for the mutation operator and the three different virtual machines, shown as a boxplot.\\protect\\label{fig:mutation:vms}">>=
...
<<r intel.onemax, echo=F, fig.height=6, fig.cap="Cores consumption for the onemax fitness function and the three different virtual machines, shown as a boxplot.\\protect\\label{fig:onemax:intel}">>=
