...
the library had to be changed (since it does not use \texttt{node_modules}), and
processing the command line arguments used a different library. Other than that,
the business logic was exactly the same.
