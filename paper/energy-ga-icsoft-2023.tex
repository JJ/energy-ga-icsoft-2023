...
systems, can be addressed at the hardware and sofware levels. In the software
level, developers focus their attention on the energy consumption of sofware,
proposing optimizations for more energy-efficient algorithm implementations.
Algorithm comparatives nowdays include power efficency as a performance metric,
...
certain parameters of the metaheuristic have an impact energy consumption.
Díaz-Álvarez et al. \cite{diaz2022population} studies how the populations size
of evolutionary algorithms (EAs) influences power consumption. In GAs, the
...
report that in a distributed evaluation setting, the comminication scheme has a
