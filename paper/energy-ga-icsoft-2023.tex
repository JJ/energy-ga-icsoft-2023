...
\item {\sf
  ...
  domain that is measured by all tools, but all of them would process device
  readings in a different way, so it will provide us with alternate measurements.
