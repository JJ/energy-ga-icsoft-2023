...
<<r pinpoint, echo=F>>=
library(ggplot2)
test.pinpoint <- read.csv("../data/pinpoint-sets-29-Mar-21-06-12.csv")
@
...
test.likwid <- read.csv("../data/likwid-sets-10-Apr-12-54-28.csv")
...
test.perf <- read.csv("../data/perfstat-deno-sets-30-Mar-14-51-25.csv")
...
sets.vms <- read.csv("../data/pinpoint-vms-sets-10-Apr-17-59-56.csv")
...
library(ggthemes)
onemax <- read.csv("../data/pinpoint-vms-onemax-11-Apr-10-19-29.csv")
...
crossover <- read.csv("../data/pinpoint-vms-crossover-11-Apr-17-06-52.csv")
