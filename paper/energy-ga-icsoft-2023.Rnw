...
Green computing
\cite{kurp2008green} refers to the design of hardware and/or software systems that are first conscious, and then minimize the energy consumption for a given workload.
