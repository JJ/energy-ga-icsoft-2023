...
<<r pinpoint.likwid, echo=F, fig.cap="Relationship between CORE measurements (likwid) and CPU measurements (pinpoint) (x and y axis, respectively.\\protect\\label{fig:pinlik}">>=
