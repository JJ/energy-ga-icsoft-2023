...
As in the previous cases, we have performed measurements for the OneMax fitness function and the Crossover operator; the platform was a MacBook Air M1 with 16GB of RAM and macOS Ventura 13.2.1. The results are shown in Figure \ref{fig:onemax:mac} and Figure \ref{fig:crossover:mac}.
...
This work is supported by the Ministerio Español de Economía y
